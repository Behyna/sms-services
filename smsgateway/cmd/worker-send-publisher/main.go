...
func main() {
	fx.New(
		...
		fx.Invoke(runSendPublisher),
	).Run()
}

func runSendPublisher(cfg *config.Config, publisher publishers.SendPublisher, logger *zap.Logger,
	...
	lc.Append(fx.Hook{
		OnStart: func(ctx context.Context) error {
			...
			logger.Info("send publisher started")
			return nil
		},
